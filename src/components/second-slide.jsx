...
const SecondSlide = () => {
  const serviceList = [
    {
      id: 1,
      heading: "Boosts Credibility:",
      description:
        "Backlinks from reputable sites signal to search engines that your content is trustworthy.",
    },
    {
      id: 2,
      heading: "Increases Traffic:",
      description:
        "Contextual placements drive targeted readers who are genuinely interested in your industry.",
    },
    {
      id: 3,
      heading: "Improves Rankings:",
      description:
        "Naturally embedded links carry more weight, enhancing your search engine positioning.",
    },
  ];
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/5">
          <MainHeading text={"Guest Post Contextual Backlinks"} />
          <SecondaryDescription
            description="We secure guest post placements on authoritative sites where your link naturally fits within relevant content. This builds credibility, attracts targeted visitors, and enhances your search rankings."
      ...
      <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
        {postPriceCards.map((card) => (
          <div key={card.id} className="relative">
            <div className="absolute inset-0 left-0 w-full h-full bg-[#CCF1FE] rounded-lg opacity-30 -top-4"></div>
            <div
              className="relative h-full p-[42px] bg-white rounded-lg shadow-lg flex flex-col justify-between"
